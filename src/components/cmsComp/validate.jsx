...
function Validate() {
  ...
  const fetchAwards = useCallback(async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/films_detail/${id}/awards`
      );
  ...
  const fetchCountry = useCallback(async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/countries/${id}`
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8000/api/films/unverified"
        );
  ...
  const handleApproveClick = async (id) => {
    try {
      await axios.put(`http://localhost:8000/api/films/approve/${id}`);
      const response = await axios.get(
        "http://localhost:8000/api/films/unverified"
      );
      setFilms(response.data);
